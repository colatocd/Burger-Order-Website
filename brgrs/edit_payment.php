...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($creditCardNumber) && !empty($expirationDate) && !empty($ccv)) {
        ...
        $sql = "UPDATE Payment SET card_number = :creditCardNumber, first_name = :firstName, last_name = :lastName, exp_date = :expirationDate, CCV = :ccv WHERE user_name = :username";
    ...
    <div class="form-container">
        <form action="edit_payment.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="firstName" name="firstName" value="<?php echo isset($payment_info['first_name']) ? $payment_info['first_name'] : ''; ?>" required>
            </div>
            <div class="form-group">
                <label for="lastName">Last Name:</label>
                <input type="text" id="lastName" name="lastName" value="<?php echo isset($payment_info['last_name']) ? $payment_info['last_name'] : ''; ?>" required>
            </div>
            <div class="form-group">
                <label for="creditCardNumber">Credit Card Number:</label>
                <input type="password" id="creditCardNumber" name="creditCardNumber" value="<?php echo $maskedCreditCardNumber; ?>" required>
            </div>
            <div class="form-group">
                <label for="ccv">CCV:</label>
                <input type="text" id="ccv" name="ccv" value="<?php echo isset($payment_info['CCV']) ? $payment_info['CCV'] : ''; ?>" required>
            </div>
            <div class="form-group">
                <label for="expirationDate">Expiration Date:</label>
                <input type="date" id="expirationDate" name="expirationDate" value="<?php echo isset($payment_info['exp_date']) ? $payment_info['exp_date'] : ''; ?>" required placeholder="MM/YYYY">
            </div>
